...
export function Form() {
	const [_error, submitAction, isPending] = useActionState(async (_previousState: any, formData: FormData) => {
		const { name, email, subject, message } = Object.fromEntries(formData) as Record<string, string>;
