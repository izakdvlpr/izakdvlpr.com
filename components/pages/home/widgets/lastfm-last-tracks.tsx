...
export function LastfmLastTracksPlayedWidget({ lastfm }: LastfmLastTracksPlayedWidgetProps) {
	return (
		<div className="md:col-span-2 col-span-1 p-5 flex flex-col gap-2 rounded-md bg-gray-100">
			...
			{lastfm?.tracks && lastfm.tracks.length > 0 ? (
				...
				<p className="mt-4 text-sm text-gray-500">No recent tracks available.</p>
			)}
		</div>
	);
}
